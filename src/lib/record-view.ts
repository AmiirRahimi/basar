  ...
  cloth: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: '_trim', label: 'خرجکار فروش', kind: 'name', linkResource: 'person' },
        { key: 'trimFee', label: 'اجرت خرجکار فروش', kind: 'toman' },
        { key: '_print', label: 'چاپ', kind: 'name', linkResource: 'person' },
        { key: 'printFee', label: 'اجرت چاپ', kind: 'toman' },
  ...
  'admin-user': [
    {
      ...
      fields: [
        ...
        { key: 'remainingPeriods', label: 'اشتراک مانده' },
        { key: 'totalPeriods', label: 'جمع اشتراک' },
        { key: 'purchaseCount', label: 'تعداد خرید' },
        { key: 'endsAt', label: 'پایان اشتراک', kind: 'date' },
  ...
  'admin-purchase': [
    {
      ...
      fields: [
        ...
        { key: 'planName', label: 'طرح' },
        { key: 'billingCycle', label: 'دوره' },
        { key: 'periodsPurchased', label: 'تعداد اشتراک' },
        { key: 'remainingPeriods', label: 'مانده' },
        ...
        { key: 'endsAt', label: 'پایان', kind: 'date' },
