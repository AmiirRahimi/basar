...
export function RecordDetail({
  ...
  const listHref = RECORD_LIST_HREF[resource] || '/accounting/dashboard';
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              {resource === 'invoice' ? (
                <>
                  <Link
                    href={`/accounting/invoices/${row._id}/print`}
                    target="_blank"
                  ...
                  <Link
                    href={`/accounting/invoices/${row._id}/bijak`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm hover:border-gray-300"
                  >
              ...
              {resource === 'person' ? (
                <Link
                  href={`/accounting/account/${row._id}/payments`}
                  className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm hover:border-gray-300"
                >
