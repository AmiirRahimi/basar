          ...
          <RowActions
            ...
            extraActions={[
                ...
                : []),
              {
                ...
                onClick: () => window.open(`/accounting/invoices/${row.original._id}/print`, '_blank', 'noopener,noreferrer'),
              },
              {
                label: 'بیجک',
                icon: <ScrollText className="size-3.5" />,
                onClick: () => window.open(`/accounting/invoices/${row.original._id}/bijak`, '_blank', 'noopener,noreferrer'),
              },
            ]}
            onDelete={
              writable
          ...
          {summary ? (
            <div className="space-y-4 text-sm">
              ...
              <div className="flex flex-wrap justify-end gap-2">
                ...
                <Button
                  variant="outline"
                  onClick={() => window.open(`/accounting/invoices/${summary.id}/bijak`, '_blank', 'noopener,noreferrer')}
                >
                  چاپ بیجک
                </Button>
                <Button
                  onClick={() => window.open(`/accounting/invoices/${summary.id}/print`, '_blank', 'noopener,noreferrer')}
                >
                  چاپ فاکتور
                </Button>
              </div>
