  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Link href="/accounting/account" className="inline-flex items-center gap-1 text-sm text-teal-800 hover:underline">
      ...
      {selectedInvoice ? (
        <p className="text-sm text-gray-600">
          ...
          <Link href={`/accounting/account/${personId}/payments`} className="text-teal-800 hover:underline">
            همه فاکتورها
          </Link>
        </p>
      ) : null}
