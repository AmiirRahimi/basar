...
export type AccountingMenuSection = {
  id: string;
  name: string;
  icon: ComponentType<{ className?: string }>;
  href?: string;
  menuItems?: AccountingMenuItem[];
};
...
const ROOT_ONLY = new Set(['/accounting/dashboard', '/admin']);
...
export function AccountingSidebar({
  ...
  const grouped = groups.map((group) => ({
    ...
    items: group.ids
      ...
      .filter(Boolean) as AccountingMenuSection[],
