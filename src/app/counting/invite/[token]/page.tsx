...
import { TeamInviteInbox } from '@/components/counting/TeamInviteInbox';
...
export default async function InvitePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const loginHref = `/counting/login?invite=${encodeURIComponent(token)}`;

  return (
    <CountingShell title="دعوت به فروشگاه" description="دعوت ارسال‌شده برای پیوستن به فروشگاه یا برند">
