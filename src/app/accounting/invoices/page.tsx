...
import { InvoiceCrud } from '@/components/accounting/InvoiceCrud';
...
export default async function InvoicesPage() {
  ...
  return (
    <AccountingShell title="فاکتور" description="بعد از ثبت فاکتور می‌توانید نقد، چک، هر دو، تخفیف و نسیه دفتر را مشخص کنید" error={errorMessage(res)}>
      <InvoiceCrud
        invoices={rows}
        people={people}
        clothes={clothes}
