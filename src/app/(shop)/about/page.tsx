...
export const metadata: Metadata = pageShare({
  title: 'درباره باسار | عمده‌فروشی پوشاک بازار بزرگ',
  description: 'باسار حجره خانواده رحیمی در بازار آهنگران است. فروش عمده شلوار جین و پوشاک با بسته.',
    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:py-16 lg:px-6">
        <p className="leading-8 text-shop-ink/75">
          باسار کار چند نسل از خانواده رحیمی است. از حجره‌های بازار آهنگران در خیابان ۱۵ خرداد، جین، کتان و پیراهن را برای فروشگاه‌ها،
