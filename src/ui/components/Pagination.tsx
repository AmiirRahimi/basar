...
import RcPagination, { type PaginationProps as RcPaginationProps } from 'rc-pagination';
...
const classes = {
  base: {
    item: '[&>.rc-pagination-item>a]:text-gray-700 [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-muted [&>.rc-pagination-item>a]:hover:text-gray-900 [&>.rc-pagination-item>a]:focus:text-gray-700 [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-transparent dark:[&>.rc-pagination-item>a]:text-gray-300 dark:[&>.rc-pagination-item>a]:hover:text-gray-100 dark:[&>.rc-pagination-item>a]:focus:text-gray-200',
    ...
    jumperDiv:
      '[&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-sm [&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-gray-500 dark:[&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-gray-400',
    jumperInput:
      '[&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:!py-[3px] [&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:text-sm [&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:border-muted [&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:ring-0 dark:[&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:bg-gray-900 dark:[&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:text-gray-200',
  },
  rounded: {
...
const iconClasses = {
  ...
  outline: 'border border-muted p-[5px] dark:border-gray-700',
...
export type PaginationProps = Omit<
  RcPaginationProps,
  'nextIcon' | 'prevIcon' | 'jumpPrevIcon' | 'jumpNextIcon'
> & {
  outline?: boolean;
  rounded?: Rounded;
  variant?: Variant;
